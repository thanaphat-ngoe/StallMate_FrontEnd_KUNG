  ...
  const handleOpeningHoursChange = (event) => {
    ...
    setProfile((prevProfile) => ({
      ...
      opening_hours: prevProfile.opening_hours.map((entry) =>
        entry.weekday === selectedDay ? { ...entry, [name]: value } : entry
      ),
    }));
      ...
      >
        ...
        >
          ...
          <h4
            ...
            style={{ marginBottom: "4vw", fontSize: "5vw" }}
          >
            Owner Profile
          </h4>
          ...
          >
            <img
              ...
              onClick={() =>
                handleAddProImageClick("owner_profile.profile_photo")
              }
            />
            <input
              id="fileInputAddPro"
          ...
          >
            <input
              ...
              onChange={(event) =>
                handleNestedInputChange(event, "owner_profile")
              }
              required
              style={{
                width: "90vw",
          ...
          {["email", "phone"].map((field, index) => (
            <div
              className="input-group d-flex justify-content-center align-items-center mb-3"
              key={index}
            >
              <input
