...
const OwnerEditProfile = () => {
	...
	const handleFinishedBtn = () => {
		console.log("update some stall data naja kung");
	};
				...
				<div className="row text-white mb-3 w-75">
					...
					>
						<img
							...
							style={{ width: "40px" }}
						/>
						<span>{authData?.ownerData.ownerName}</span>
					</div>
				</div>
			...
			<div className="row mb-5 d-flex justify-content-center">
				<div className="col-12 d-flex justify-content-center">
					<button className="btn">
						<h4 className="text-white border-0 p-3" onClick={handleFinishedBtn} style={{ width: "22rem", backgroundColor: "#2B964F", borderRadius: "20px" }}>
							Finished
						</h4>
					</button>
				</div>
